...
# source of this code can be found at https://csg.sph.umich.edu/abecasis/Exact/r_instruct.html
# This method is used by GATK to calcualte ExcessHet (https://gatk.broadinstitute.org/hc/en-us/articles/360037261311-ExcessHet)
